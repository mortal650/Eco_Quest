...
class _StudentDashboardState extends ConsumerState<StudentDashboard> {
  ...
  Widget _buildProgressStats(
      BuildContext context, AsyncValue<dynamic> profileAsync) {
    return profileAsync.when(
      loading: () => const Row(
        children: [
          Expanded(
              child: _StatCard(icon: Icons.star, label: 'XP', value: '...')),
          SizedBox(width: 8),
          Expanded(
              child:
                  _StatCard(icon: Icons.leaderboard, label: 'Level', value: '...')),
          SizedBox(width: 8),
          Expanded(
              child: _StatCard(
                  icon: Icons.local_fire_department, label: 'Streak', value: '...')),
        ],
      ),
      ...
      data: (profile) {
        ...
        return Row(
          children: [
            ...
            _StatCard(
                icon: Icons.leaderboard, label: 'Level', value: '${profile.level}'),
            const SizedBox(width: 8),
            _StatCard(
  ...
  Widget _buildModulesPreview(BuildContext context) {
    return Card(
      child: ListTile(
        ...
        title: const Text('Browse Learning Modules'),
        subtitle: const Text('Plastic Pollution, Climate Change, and more'),
